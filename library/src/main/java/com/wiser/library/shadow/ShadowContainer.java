...
public class ShadowContainer extends FrameLayout {
	...
	private void initViews(AttributeSet attrs) {
		...
		if (typedArray != null) {
			...
			mShadowRadius = typedArray.getDimension(R.styleable.ShadowContainer_container_shadowRadius, dip2px(0));

			mRoundCornerRadius = typedArray.getDimension(R.styleable.ShadowContainer_container_shadowRoundRadius, dip2px(0));

			mShadowSide = typedArray.getInt(R.styleable.ShadowContainer_container_shadowSide, ALL);

			mShadowShape = typedArray.getInt(R.styleable.ShadowContainer_container_shadowShape, SHAPE_RECTANGLE);

			mCornerPosition = typedArray.getInt(R.styleable.ShadowContainer_container_round_corner, CORNER_ALL);
	...
	@Override protected void onDraw(Canvas canvas) {
		...
		if (mShadowShape == SHAPE_RECTANGLE) {
			...
			if ((mShadowSide & LEFT) == LEFT && (mShadowSide & TOP) != TOP && (mShadowSide & RIGHT) != RIGHT && (mShadowSide & BOTTOM) != BOTTOM) {
				...
				// 画下边阴影
				drawRectLinearGradient(canvas, 0, mViewHeight - mShadowRadius, 0, mViewHeight, colors, floats, Shader.TileMode.CLAMP,
						new RectF(0, mViewHeight - mShadowRadius, mViewWidth, mViewHeight));
			} else {
				...
				if ((mShadowSide & LEFT) == LEFT && (mShadowSide & TOP) == TOP && (mShadowSide & RIGHT) != RIGHT && (mShadowSide & BOTTOM) != BOTTOM) {
					...
					// 画右边阴影
					drawRectLinearGradient(canvas, mViewWidth - mShadowRadius, 0, mViewWidth, 0, colors, floats, Shader.TileMode.CLAMP,
							new RectF(mViewWidth - mShadowRadius, 0, mViewWidth, mViewHeight));
					...
					// 画下边阴影
					drawRectLinearGradient(canvas, 0, mViewHeight - mShadowRadius, 0, mViewHeight, colors, floats, Shader.TileMode.CLAMP,
							new RectF(mShadowRadius, mViewHeight - mShadowRadius, mViewWidth, mViewHeight));

					// 画左边和下边角落的阴影

					drawArcRadialGradient(canvas, mShadowRadius, mViewHeight - mShadowRadius, mShadowRadius, colors, floats, Shader.TileMode.CLAMP,
							new RectF(0, mViewHeight - 2 * mShadowRadius, 2 * mShadowRadius, mViewHeight), 90, 90);
					...
					// 画右边阴影
					drawRectLinearGradient(canvas, mViewWidth - mShadowRadius, 0, mViewWidth, 0, colors, floats, Shader.TileMode.CLAMP,
							new RectF(mViewWidth - mShadowRadius, mShadowRadius, mViewWidth, mViewHeight));

					// 画上边和右边角落的阴影
					drawArcRadialGradient(canvas, mViewWidth - mShadowRadius, mShadowRadius, mShadowRadius, colors, floats, Shader.TileMode.CLAMP,
							new RectF(mViewWidth - 2 * mShadowRadius, 0, mViewWidth, 2 * mShadowRadius), 270, 90);
					...
					// 画右边阴影
					drawRectLinearGradient(canvas, mViewWidth - mShadowRadius, 0, mViewWidth, 0, colors, floats, Shader.TileMode.CLAMP,
							new RectF(mViewWidth - mShadowRadius, 0, mViewWidth, mViewHeight - mShadowRadius));

					// 画下边和右边角落的阴影
					drawArcRadialGradient(canvas, mViewWidth - mShadowRadius, mViewHeight - mShadowRadius, mShadowRadius, colors, floats, Shader.TileMode.CLAMP,
							new RectF(mViewWidth - 2 * mShadowRadius, mViewHeight - 2 * mShadowRadius, mViewWidth, mViewHeight), 0, 90);

					// 画下边阴影
					drawRectLinearGradient(canvas, 0, mViewHeight - mShadowRadius, 0, mViewHeight, colors, floats, Shader.TileMode.CLAMP,
							new RectF(mShadowRadius, mViewHeight - mShadowRadius, mViewWidth - mShadowRadius, mViewHeight));
					...
					// 画右边阴影
					drawRectLinearGradient(canvas, mViewWidth - mShadowRadius, 0, mViewWidth, 0, colors, floats, Shader.TileMode.CLAMP,
							new RectF(mViewWidth - mShadowRadius, mShadowRadius, mViewWidth, mViewHeight - mShadowRadius));
					...
					// 画下边阴影
					drawRectLinearGradient(canvas, 0, mViewHeight - mShadowRadius, 0, mViewHeight, colors, floats, Shader.TileMode.CLAMP,
							new RectF(0, mViewHeight - mShadowRadius, mViewWidth - mShadowRadius, mViewHeight));
			...
			if ((mShadowSide & LEFT) == LEFT && (mShadowSide & TOP) != TOP && (mShadowSide & RIGHT) != RIGHT && (mShadowSide & BOTTOM) != BOTTOM) {
				...
				if ((mShadowSide & LEFT) == LEFT && (mShadowSide & TOP) == TOP && (mShadowSide & RIGHT) != RIGHT && (mShadowSide & BOTTOM) != BOTTOM) {// 左边和上边
					...
					if ((mCornerPosition & CORNER_LEFT_TOP) == CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) == CORNER_LEFT_BOTTOM
							&& (mCornerPosition & CORNER_RIGHT_TOP) == CORNER_RIGHT_TOP) {
						...
						drawRightTopUpArcGradient(canvas, colors, floats);
							...
							&& (mCornerPosition & CORNER_RIGHT_TOP) != CORNER_RIGHT_TOP) {
								...
								colors = creatThreePositionColor();
								// 画左边阴影
								drawRectLinearGradient(canvas, mShadowRadius + mRoundCornerRadius, 0, 0, 0, colors, floats, Shader.TileMode.CLAMP,
										new RectF(0, mShadowRadius + mRoundCornerRadius, mShadowRadius + mRoundCornerRadius, mViewHeight));
								// 画左上角阴影
								drawArcRadialGradient(canvas, mShadowRadius + mRoundCornerRadius, mShadowRadius + mRoundCornerRadius, mShadowRadius + mRoundCornerRadius, colors, floats,
										Shader.TileMode.CLAMP, new RectF(0, 0, 2 * (mShadowRadius + mRoundCornerRadius), 2 * (mShadowRadius + mRoundCornerRadius)), 180, 90);
								// 画上边阴影
								drawRectLinearGradient(canvas, 0, mShadowRadius + mRoundCornerRadius, 0, 0, colors, floats, Shader.TileMode.CLAMP,
										new RectF(mShadowRadius + mRoundCornerRadius, 0, mViewWidth, mShadowRadius + mRoundCornerRadius));
							...
							if ((mCornerPosition & CORNER_LEFT_TOP) != CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) != CORNER_LEFT_BOTTOM
								...
								if ((mCornerPosition & CORNER_LEFT_TOP) == CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) != CORNER_LEFT_BOTTOM
										&& (mCornerPosition & CORNER_RIGHT_TOP) == CORNER_RIGHT_TOP) {
											...
											// 画上边阴影
											drawRectLinearGradient(canvas, 0, mShadowRadius + mRoundCornerRadius, 0, 0, colors, floats, Shader.TileMode.CLAMP,
													new RectF(mShadowRadius + mRoundCornerRadius, 0, mViewWidth - (mRoundCornerRadius), mShadowRadius));
											// 画右上角
											RectF rf = new RectF(mViewWidth - (2 * mRoundCornerRadius), 0, mViewWidth, 2 * (mShadowRadius + mRoundCornerRadius));
											drawArcRadialGradient(canvas, mViewWidth - mRoundCornerRadius, mShadowRadius + mRoundCornerRadius, mShadowRadius + mRoundCornerRadius, colors, floats,
													Shader.TileMode.CLAMP, rf, 270, 90);
										} else
									if ((mCornerPosition & CORNER_LEFT_TOP) == CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) == CORNER_LEFT_BOTTOM
											&& (mCornerPosition & CORNER_RIGHT_TOP) != CORNER_RIGHT_TOP) {
												...
												// 画左边阴影
												drawRectLinearGradient(canvas, mShadowRadius + mRoundCornerRadius, 0, 0, 0, colors, floats, Shader.TileMode.CLAMP,
														new RectF(0, mShadowRadius + mRoundCornerRadius, mShadowRadius + mRoundCornerRadius, mViewHeight - (mRoundCornerRadius)));
												// 画上边阴影
												drawRectLinearGradient(canvas, 0, mShadowRadius + mRoundCornerRadius, 0, 0, colors, floats, Shader.TileMode.CLAMP,
														new RectF(mShadowRadius + mRoundCornerRadius, 0, mViewWidth, mShadowRadius));
												// 画上边和左边角落的阴影
												drawArcRadialGradient(canvas, mShadowRadius + mRoundCornerRadius, mShadowRadius + mRoundCornerRadius, mShadowRadius + mRoundCornerRadius, colors,
														floats, Shader.TileMode.CLAMP, new RectF(0, 0, 2 * (mShadowRadius + mRoundCornerRadius), 2 * (mShadowRadius + mRoundCornerRadius)), 180, 90);
												// 画左下角阴影
												RectF rf = new RectF(0, mViewHeight - (2 * mRoundCornerRadius), 2 * (mShadowRadius + mRoundCornerRadius), mViewHeight);
												drawArcRadialGradient(canvas, mShadowRadius + mRoundCornerRadius, mViewHeight - (mRoundCornerRadius), mShadowRadius + mRoundCornerRadius, colors,
														floats, Shader.TileMode.CLAMP, rf, 90, 90);
										...
										if ((mCornerPosition & CORNER_LEFT_TOP) != CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) == CORNER_LEFT_BOTTOM
												&& (mCornerPosition & CORNER_RIGHT_TOP) == CORNER_RIGHT_TOP) {
													...
													// 画左边阴影
													drawRectLinearGradient(canvas, mShadowRadius, 0, 0, 0, colors, floats, Shader.TileMode.CLAMP,
															new RectF(0, mShadowRadius, mShadowRadius, mViewHeight));
													// 画上边阴影
													drawRectLinearGradient(canvas, 0, mShadowRadius, 0, 0, colors, floats, Shader.TileMode.CLAMP,
															new RectF(mShadowRadius, 0, mViewWidth, mShadowRadius));
													// 画上边和左边角落的阴影
													drawArcRadialGradient(canvas, mShadowRadius, mShadowRadius, mShadowRadius, colors, floats, Shader.TileMode.CLAMP,
															new RectF(0, 0, 2 * mShadowRadius, 2 * mShadowRadius), 180, 90);
												}

				} else if ((mShadowSide & LEFT) == LEFT && (mShadowSide & RIGHT) == RIGHT && (mShadowSide & TOP) != TOP && (mShadowSide & BOTTOM) != BOTTOM) {// 左边和右边

					if ((mCornerPosition & CORNER_LEFT_TOP) == CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) == CORNER_LEFT_BOTTOM
							&& (mCornerPosition & CORNER_RIGHT_TOP) == CORNER_RIGHT_TOP && (mCornerPosition & CORNER_RIGHT_BOTTOM) == CORNER_RIGHT_BOTTOM) {
						...
						// 画左边阴影
						drawRectLinearGradient(canvas, mShadowRadius + mRoundCornerRadius, 0, 0, 0, colors, floats, Shader.TileMode.CLAMP,
								new RectF(0, mRoundCornerRadius, mShadowRadius + mRoundCornerRadius, mViewHeight - (mRoundCornerRadius)));
						// 画左上角阴影
						drawArcRadialGradient(canvas, mShadowRadius + mRoundCornerRadius, mRoundCornerRadius, mShadowRadius + mRoundCornerRadius, colors, floats, Shader.TileMode.CLAMP,
								new RectF(0, 0, 2 * (mShadowRadius + mRoundCornerRadius), 2 * (mRoundCornerRadius)), 180, 90);

						// 画左下角阴影
						RectF rf = new RectF(0, mViewHeight - (2 * mRoundCornerRadius), 2 * (mShadowRadius + mRoundCornerRadius), mViewHeight);
						drawArcRadialGradient(canvas, mShadowRadius + mRoundCornerRadius, mViewHeight - (mRoundCornerRadius), mShadowRadius + mRoundCornerRadius, colors, floats, Shader.TileMode.CLAMP,
								rf, 90, 90);
						// 画右上角阴影
						rf = new RectF(mViewWidth - 2 * (mShadowRadius + mRoundCornerRadius), 0, mViewWidth, 2 * (mRoundCornerRadius));
						drawArcRadialGradient(canvas, mViewWidth - (mShadowRadius + mRoundCornerRadius), mRoundCornerRadius, mShadowRadius + mRoundCornerRadius, colors, floats, Shader.TileMode.CLAMP,
								rf, 270, 90);
						// 画右边阴影
						drawRectLinearGradient(canvas, mViewWidth - (mShadowRadius + mRoundCornerRadius), 0, mViewWidth, 0, colors, floats, Shader.TileMode.CLAMP,
								new RectF(mViewWidth - (mShadowRadius + mRoundCornerRadius), mRoundCornerRadius, mViewWidth, mViewHeight - (mRoundCornerRadius)));

						// 画右下角阴影
						rf = new RectF(mViewWidth - 2 * (mShadowRadius + mRoundCornerRadius), mViewHeight - (2 * mRoundCornerRadius), mViewWidth, mViewHeight);
						drawArcRadialGradient(canvas, mViewWidth - (mShadowRadius + mRoundCornerRadius), mViewHeight - (mRoundCornerRadius), mShadowRadius + mRoundCornerRadius, colors, floats,
								Shader.TileMode.CLAMP, rf, 0, 90);
						...
						// canvas.drawRect(rf,paint);
							...
							&& (mCornerPosition & CORNER_RIGHT_TOP) != CORNER_RIGHT_TOP && (mCornerPosition & CORNER_RIGHT_BOTTOM) != CORNER_RIGHT_BOTTOM) {
								...
								// 画左边阴影
								drawRectLinearGradient(canvas, mShadowRadius + mRoundCornerRadius, 0, 0, 0, colors, floats, Shader.TileMode.CLAMP,
										new RectF(0, mRoundCornerRadius, mShadowRadius + mRoundCornerRadius, mViewHeight));
								// 画左上角阴影
								drawArcRadialGradient(canvas, mShadowRadius + mRoundCornerRadius, mRoundCornerRadius, mShadowRadius + mRoundCornerRadius, colors, floats, Shader.TileMode.CLAMP,
										new RectF(0, 0, 2 * (mShadowRadius + mRoundCornerRadius), 2 * (mRoundCornerRadius)), 180, 90);
						...
						if ((mCornerPosition & CORNER_LEFT_TOP) != CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) == CORNER_LEFT_BOTTOM
								&& (mCornerPosition & CORNER_RIGHT_TOP) != CORNER_RIGHT_TOP && (mCornerPosition & CORNER_RIGHT_BOTTOM) != CORNER_RIGHT_BOTTOM) {
									...
									// 画左边阴影
									drawRectLinearGradient(canvas, mShadowRadius + mRoundCornerRadius, 0, 0, 0, colors, floats, Shader.TileMode.CLAMP,
											new RectF(0, 0, mShadowRadius + mRoundCornerRadius, mViewHeight - (mRoundCornerRadius)));
									// 画左下角阴影
									RectF rf = new RectF(0, mViewHeight - (2 * mRoundCornerRadius), 2 * (mShadowRadius + mRoundCornerRadius), mViewHeight);

									drawArcRadialGradient(canvas, mShadowRadius + mRoundCornerRadius, mViewHeight - (mRoundCornerRadius), mShadowRadius + mRoundCornerRadius, colors, floats,
											Shader.TileMode.CLAMP, rf, 90, 90);
								...
								if ((mCornerPosition & CORNER_LEFT_TOP) == CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) == CORNER_LEFT_BOTTOM
										&& (mCornerPosition & CORNER_RIGHT_TOP) == CORNER_RIGHT_TOP && (mCornerPosition & CORNER_RIGHT_BOTTOM) != CORNER_RIGHT_BOTTOM) {
											...
											drawRectLinearGradient(canvas, mShadowRadius + mRoundCornerRadius, 0, 0, 0, colors, floats, Shader.TileMode.CLAMP,
													new RectF(0, mRoundCornerRadius, mShadowRadius + mRoundCornerRadius, mViewHeight - (mRoundCornerRadius)));
											// 画左上角阴影
											drawArcRadialGradient(canvas, mShadowRadius + mRoundCornerRadius, mRoundCornerRadius, mShadowRadius + mRoundCornerRadius, colors, floats,
													Shader.TileMode.CLAMP, new RectF(0, 0, 2 * (mShadowRadius + mRoundCornerRadius), 2 * (mRoundCornerRadius)), 180, 90);
											...
											// 画右上角阴影
											rf = new RectF(mViewWidth - 2 * (mShadowRadius + mRoundCornerRadius), 0, mViewWidth, 2 * (mRoundCornerRadius));
											drawArcRadialGradient(canvas, mViewWidth - (mShadowRadius + mRoundCornerRadius), mRoundCornerRadius, mShadowRadius + mRoundCornerRadius, colors, floats,
													Shader.TileMode.CLAMP, rf, 270, 90);
											// 画右边阴影
											drawRectLinearGradient(canvas, mViewWidth - (mShadowRadius + mRoundCornerRadius), 0, mViewWidth, 0, colors, floats, Shader.TileMode.CLAMP,
													new RectF(mViewWidth - (mShadowRadius + mRoundCornerRadius), mRoundCornerRadius, mViewWidth, mViewHeight));
									...
									if ((mCornerPosition & CORNER_LEFT_TOP) == CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) == CORNER_LEFT_BOTTOM
											&& (mCornerPosition & CORNER_RIGHT_TOP) != CORNER_RIGHT_TOP && (mCornerPosition & CORNER_RIGHT_BOTTOM) == CORNER_RIGHT_BOTTOM) {
												...
												// 画右边阴影
												drawRectLinearGradient(canvas, mViewWidth - (mShadowRadius + mRoundCornerRadius), 0, mViewWidth, 0, colors, floats, Shader.TileMode.CLAMP,
														new RectF(mViewWidth - (mShadowRadius + mRoundCornerRadius), 0, mViewWidth, mViewHeight - (mRoundCornerRadius)));

												// 画右下角阴影
												rf = new RectF(mViewWidth - 2 * (mShadowRadius + mRoundCornerRadius), mViewHeight - (2 * mRoundCornerRadius), mViewWidth, mViewHeight);
												drawArcRadialGradient(canvas, mViewWidth - (mShadowRadius + mRoundCornerRadius), mViewHeight - (mRoundCornerRadius), mShadowRadius + mRoundCornerRadius,
														colors, floats, Shader.TileMode.CLAMP, rf, 0, 90);
										...
										if ((mCornerPosition & CORNER_LEFT_TOP) != CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) != CORNER_LEFT_BOTTOM
												&& (mCornerPosition & CORNER_RIGHT_TOP) != CORNER_RIGHT_TOP && (mCornerPosition & CORNER_RIGHT_BOTTOM) == CORNER_RIGHT_BOTTOM) {
													...
													drawArcRadialGradient(canvas, mViewWidth - (mShadowRadius + mRoundCornerRadius), mViewHeight - (mRoundCornerRadius),
															mShadowRadius + mRoundCornerRadius, colors, floats, Shader.TileMode.CLAMP, rf, 0, 90);
											...
											if ((mCornerPosition & CORNER_LEFT_TOP) != CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) != CORNER_LEFT_BOTTOM
													&& (mCornerPosition & CORNER_RIGHT_TOP) == CORNER_RIGHT_TOP && (mCornerPosition & CORNER_RIGHT_BOTTOM) != CORNER_RIGHT_BOTTOM) {
														...
														drawArcRadialGradient(canvas, mViewWidth - (mShadowRadius + mRoundCornerRadius), mRoundCornerRadius, mShadowRadius + mRoundCornerRadius, colors,
																floats, Shader.TileMode.CLAMP, rf, 270, 90);
														// 画右边阴影
														drawRectLinearGradient(canvas, mViewWidth - (mShadowRadius + mRoundCornerRadius), 0, mViewWidth, 0, colors, floats, Shader.TileMode.CLAMP,
																new RectF(mViewWidth - (mShadowRadius + mRoundCornerRadius), mRoundCornerRadius, mViewWidth, mViewHeight));
												...
												if ((mCornerPosition & CORNER_LEFT_TOP) != CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) != CORNER_LEFT_BOTTOM
														&& (mCornerPosition & CORNER_RIGHT_TOP) == CORNER_RIGHT_TOP && (mCornerPosition & CORNER_RIGHT_BOTTOM) == CORNER_RIGHT_BOTTOM) {
															...
															// 画右上角阴影
															RectF rf = new RectF(mViewWidth - 2 * (mShadowRadius + mRoundCornerRadius), 0, mViewWidth, 2 * (mRoundCornerRadius));
															drawArcRadialGradient(canvas, mViewWidth - (mShadowRadius + mRoundCornerRadius), mRoundCornerRadius, mShadowRadius + mRoundCornerRadius,
																	colors, floats, Shader.TileMode.CLAMP, rf, 270, 90);
															// 画右边阴影
															drawRectLinearGradient(canvas, mViewWidth - (mShadowRadius + mRoundCornerRadius), 0, mViewWidth, 0, colors, floats, Shader.TileMode.CLAMP,
																	new RectF(mViewWidth - (mShadowRadius + mRoundCornerRadius), mRoundCornerRadius, mViewWidth, mViewHeight - (mRoundCornerRadius)));
													...
													if ((mCornerPosition & CORNER_LEFT_TOP) == CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) != CORNER_LEFT_BOTTOM
															&& (mCornerPosition & CORNER_RIGHT_TOP) == CORNER_RIGHT_TOP && (mCornerPosition & CORNER_RIGHT_BOTTOM) == CORNER_RIGHT_BOTTOM) {
																...
																drawRectLinearGradient(canvas, mShadowRadius + mRoundCornerRadius, 0, 0, 0, colors, floats, Shader.TileMode.CLAMP,
																		new RectF(0, mRoundCornerRadius, mShadowRadius + mRoundCornerRadius, mViewHeight));
																// 画左上角阴影
																drawArcRadialGradient(canvas, mShadowRadius + mRoundCornerRadius, mRoundCornerRadius, mShadowRadius + mRoundCornerRadius, colors,
																		floats, Shader.TileMode.CLAMP, new RectF(0, 0, 2 * (mShadowRadius + mRoundCornerRadius), 2 * (mRoundCornerRadius)), 180, 90);
																...
																drawArcRadialGradient(canvas, mViewWidth - (mShadowRadius + mRoundCornerRadius), mRoundCornerRadius, mShadowRadius + mRoundCornerRadius,
																		colors, floats, Shader.TileMode.CLAMP, rf, 270, 90);
																// 画右边阴影
																drawRectLinearGradient(canvas, mViewWidth - (mShadowRadius + mRoundCornerRadius), 0, mViewWidth, 0, colors, floats,
																		Shader.TileMode.CLAMP, new RectF(mViewWidth - (mShadowRadius + mRoundCornerRadius), mRoundCornerRadius, mViewWidth,
																				mViewHeight - (mRoundCornerRadius)));
														...
														if ((mCornerPosition & CORNER_LEFT_TOP) != CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) == CORNER_LEFT_BOTTOM
																&& (mCornerPosition & CORNER_RIGHT_TOP) == CORNER_RIGHT_TOP && (mCornerPosition & CORNER_RIGHT_BOTTOM) == CORNER_RIGHT_BOTTOM) {
																	...
																	drawArcRadialGradient(canvas, mShadowRadius + mRoundCornerRadius, mViewHeight - (mRoundCornerRadius),
																			mShadowRadius + mRoundCornerRadius, colors, floats, Shader.TileMode.CLAMP, rf, 90, 90);

																	// 画右上角阴影
																	rf = new RectF(mViewWidth - 2 * (mShadowRadius + mRoundCornerRadius), 0, mViewWidth, 2 * (mRoundCornerRadius));
																	drawArcRadialGradient(canvas, mViewWidth - (mShadowRadius + mRoundCornerRadius), mRoundCornerRadius,
																			mShadowRadius + mRoundCornerRadius, colors, floats, Shader.TileMode.CLAMP, rf, 270, 90);
																	// 画右边阴影
																	drawRectLinearGradient(canvas, mViewWidth - (mShadowRadius + mRoundCornerRadius), 0, mViewWidth, 0, colors, floats,
																			Shader.TileMode.CLAMP, new RectF(mViewWidth - (mShadowRadius + mRoundCornerRadius), mRoundCornerRadius, mViewWidth,
																					mViewHeight - (mRoundCornerRadius)));
																	...
																	// 画右下角阴影
																	rf = new RectF(mViewWidth - 2 * (mShadowRadius + mRoundCornerRadius), mViewHeight - (2 * mRoundCornerRadius), mViewWidth,
																			mViewHeight);
																	drawArcRadialGradient(canvas, mViewWidth - (mShadowRadius + mRoundCornerRadius), mViewHeight - (mRoundCornerRadius),
																			mShadowRadius + mRoundCornerRadius, colors, floats, Shader.TileMode.CLAMP, rf, 0, 90);
															...
															if ((mCornerPosition & CORNER_LEFT_TOP) != CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) == CORNER_LEFT_BOTTOM
																...
																if ((mCornerPosition & CORNER_LEFT_TOP) != CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) == CORNER_LEFT_BOTTOM
																	...
																	if ((mCornerPosition & CORNER_LEFT_TOP) == CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) != CORNER_LEFT_BOTTOM
																			&& (mCornerPosition & CORNER_RIGHT_TOP) == CORNER_RIGHT_TOP
																			&& (mCornerPosition & CORNER_RIGHT_BOTTOM) != CORNER_RIGHT_BOTTOM) {
																				...
																				drawRectLinearGradient(canvas, mShadowRadius + mRoundCornerRadius, 0, 0, 0, colors, floats, Shader.TileMode.CLAMP,
																						new RectF(0, mRoundCornerRadius, mShadowRadius + mRoundCornerRadius, mViewHeight));
																				// 画左上角阴影
																				drawArcRadialGradient(canvas, mShadowRadius + mRoundCornerRadius, mRoundCornerRadius,
																						mShadowRadius + mRoundCornerRadius, colors, floats, Shader.TileMode.CLAMP,
																						new RectF(0, 0, 2 * (mShadowRadius + mRoundCornerRadius), 2 * (mRoundCornerRadius)), 180, 90);
																		...
																		if ((mCornerPosition & CORNER_LEFT_TOP) == CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) != CORNER_LEFT_BOTTOM
																				...
																				&& (mCornerPosition & CORNER_RIGHT_BOTTOM) == CORNER_RIGHT_BOTTOM) {
																					...
																					// 画右边阴影
																					drawRectLinearGradient(canvas, mViewWidth - (mShadowRadius + mRoundCornerRadius), 0, mViewWidth, 0, colors, floats,
																							Shader.TileMode.CLAMP, new RectF(mViewWidth - (mShadowRadius + mRoundCornerRadius), 0, mViewWidth,
																									mViewHeight - (mRoundCornerRadius)));

																					// 画右下角阴影
																					RectF rf = new RectF(mViewWidth - 2 * (mShadowRadius + mRoundCornerRadius), mViewHeight - (2 * mRoundCornerRadius),
																					...
																					// 画左边阴影
																					drawRectLinearGradient(canvas, mShadowRadius, 0, 0, 0, colors, floats, Shader.TileMode.CLAMP,
																							new RectF(0, 0, mShadowRadius, mViewHeight));
					...
					if ((mCornerPosition & CORNER_LEFT_TOP) == CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) == CORNER_LEFT_BOTTOM
						...
						// 画左边阴影
						drawRectLinearGradient(canvas, mShadowRadius + mRoundCornerRadius, 0, 0, 0, colors, floats, Shader.TileMode.CLAMP,
								new RectF(0, mRoundCornerRadius, mShadowRadius + mRoundCornerRadius, mViewHeight - (mShadowRadius + mRoundCornerRadius)));
						// 画左上角阴影
						drawArcRadialGradient(canvas, mShadowRadius + mRoundCornerRadius, mRoundCornerRadius, mShadowRadius + mRoundCornerRadius, colors, floats, Shader.TileMode.CLAMP,
								new RectF(0, 0, 2 * (mShadowRadius + mRoundCornerRadius), 2 * (mRoundCornerRadius)), 180, 90);

						// 画下边阴影
						drawRectLinearGradient(canvas, 0, mViewHeight - (mShadowRadius + mRoundCornerRadius), 0, mViewHeight, colors, floats, Shader.TileMode.CLAMP,
								new RectF(mShadowRadius + mRoundCornerRadius, mViewHeight - (mShadowRadius + mRoundCornerRadius), mViewWidth - (mRoundCornerRadius), mViewHeight));
						// //画左下角阴影
						RectF rf = new RectF(0, mViewHeight - 2 * (mShadowRadius + mRoundCornerRadius), 2 * (mShadowRadius + mRoundCornerRadius), mViewHeight);
						drawArcRadialGradient(canvas, mShadowRadius + mRoundCornerRadius, mViewHeight - (mShadowRadius + mRoundCornerRadius), mShadowRadius + mRoundCornerRadius, colors, floats,
								Shader.TileMode.CLAMP, rf, 90, 90);
						// //画右下角阴影
						rf = new RectF(mViewWidth - 2 * (mRoundCornerRadius), mViewHeight - 2 * (mShadowRadius + mRoundCornerRadius), mViewWidth, mViewHeight);
						drawArcRadialGradient(canvas, mViewWidth - (mRoundCornerRadius), mViewHeight - (mShadowRadius + mRoundCornerRadius), mShadowRadius + mRoundCornerRadius, colors, floats,
								Shader.TileMode.CLAMP, rf, 0, 90);
							...
							&& (mCornerPosition & CORNER_RIGHT_BOTTOM) != CORNER_RIGHT_BOTTOM) {
								...
								// 画左边阴影
								drawRectLinearGradient(canvas, mShadowRadius + mRoundCornerRadius, 0, 0, 0, colors, floats, Shader.TileMode.CLAMP,
										new RectF(0, mRoundCornerRadius, mShadowRadius + mRoundCornerRadius, mViewHeight - (mShadowRadius)));
								// 画左上角阴影
								drawArcRadialGradient(canvas, mShadowRadius + mRoundCornerRadius, mRoundCornerRadius, mShadowRadius + mRoundCornerRadius, colors, floats, Shader.TileMode.CLAMP,
										new RectF(0, 0, 2 * (mShadowRadius + mRoundCornerRadius), 2 * (mRoundCornerRadius)), 180, 90);
						...
						if ((mCornerPosition & CORNER_LEFT_TOP) != CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) == CORNER_LEFT_BOTTOM
								&& (mCornerPosition & CORNER_RIGHT_BOTTOM) != CORNER_RIGHT_BOTTOM) {
									...
									// 画左边阴影
									drawRectLinearGradient(canvas, mShadowRadius, 0, 0, 0, colors, floats, Shader.TileMode.CLAMP,
											new RectF(0, 0, mShadowRadius, mViewHeight - (mShadowRadius + mRoundCornerRadius)));

									// 画下边阴影
									drawRectLinearGradient(canvas, 0, mViewHeight - mShadowRadius, 0, mViewHeight, colors, floats, Shader.TileMode.CLAMP,
											new RectF(mShadowRadius + mRoundCornerRadius, mViewHeight - mShadowRadius, mViewWidth, mViewHeight));
									...
									// 画左下角阴影
									RectF rf = new RectF(0, mViewHeight - 2 * (mShadowRadius + mRoundCornerRadius), 2 * (mShadowRadius + mRoundCornerRadius), mViewHeight);
									drawArcRadialGradient(canvas, mShadowRadius + mRoundCornerRadius, mViewHeight - (mShadowRadius + mRoundCornerRadius), mShadowRadius + mRoundCornerRadius, colors,
											floats, Shader.TileMode.CLAMP, rf, 90, 90);
							...
							if ((mCornerPosition & CORNER_LEFT_TOP) != CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) != CORNER_LEFT_BOTTOM
									&& (mCornerPosition & CORNER_RIGHT_BOTTOM) == CORNER_RIGHT_BOTTOM) {
										...
										// 画下边阴影
										drawRectLinearGradient(canvas, 0, mViewHeight - mShadowRadius, 0, mViewHeight, colors, floats, Shader.TileMode.CLAMP,
												new RectF(mShadowRadius, mViewHeight - mShadowRadius, mViewWidth - mRoundCornerRadius, mViewHeight));
										// 画左下直角的阴影
										drawArcRadialGradient(canvas, mShadowRadius, mViewHeight - mShadowRadius, mShadowRadius, colors, floats, Shader.TileMode.CLAMP,
												new RectF(0, mViewHeight - 2 * mShadowRadius, 2 * mShadowRadius, mViewHeight), 90, 90);
										...
										drawArcRadialGradient(canvas, mViewWidth - (mRoundCornerRadius), mViewHeight - (mShadowRadius + mRoundCornerRadius), mShadowRadius + mRoundCornerRadius, colors,
												floats, Shader.TileMode.CLAMP, rf, 0, 90);
								...
								if ((mCornerPosition & CORNER_LEFT_TOP) == CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) != CORNER_LEFT_BOTTOM
										&& (mCornerPosition & CORNER_RIGHT_BOTTOM) == CORNER_RIGHT_BOTTOM) {
											...
											// 画右下角阴影
											RectF rf = new RectF(mViewWidth - 2 * (mRoundCornerRadius), mViewHeight - 2 * (mShadowRadius + mRoundCornerRadius), mViewWidth, mViewHeight);
											drawArcRadialGradient(canvas, mViewWidth - (mRoundCornerRadius), mViewHeight - (mShadowRadius + mRoundCornerRadius), mShadowRadius + mRoundCornerRadius,
													colors, floats, Shader.TileMode.CLAMP, rf, 0, 90);
									...
									if ((mCornerPosition & CORNER_LEFT_TOP) == CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) == CORNER_LEFT_BOTTOM
											&& (mCornerPosition & CORNER_RIGHT_BOTTOM) != CORNER_RIGHT_BOTTOM) {
												...
												// 画下边阴影
												drawRectLinearGradient(canvas, 0, mViewHeight - (mShadowRadius + mRoundCornerRadius), 0, mViewHeight, colors, floats, Shader.TileMode.CLAMP,
														new RectF(mShadowRadius + mRoundCornerRadius, mViewHeight - (mShadowRadius + mRoundCornerRadius), mViewWidth, mViewHeight));
												// //画左下角阴影
												RectF rf = new RectF(0, mViewHeight - 2 * (mShadowRadius + mRoundCornerRadius), 2 * (mShadowRadius + mRoundCornerRadius), mViewHeight);
												drawArcRadialGradient(canvas, mShadowRadius + mRoundCornerRadius, mViewHeight - (mShadowRadius + mRoundCornerRadius),
														mShadowRadius + mRoundCornerRadius, colors, floats, Shader.TileMode.CLAMP, rf, 90, 90);
										...
										if ((mCornerPosition & CORNER_LEFT_TOP) != CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) == CORNER_LEFT_BOTTOM
												&& (mCornerPosition & CORNER_RIGHT_BOTTOM) == CORNER_RIGHT_BOTTOM) {
													...
													// 画左边阴影
													drawRectLinearGradient(canvas, mShadowRadius + mRoundCornerRadius, 0, 0, 0, colors, floats, Shader.TileMode.CLAMP,
															new RectF(0, 0, mShadowRadius + mRoundCornerRadius, mViewHeight - (mShadowRadius + mRoundCornerRadius)));

													// 画下边阴影
													drawRectLinearGradient(canvas, 0, mViewHeight - (mShadowRadius + mRoundCornerRadius), 0, mViewHeight, colors, floats, Shader.TileMode.CLAMP,
															new RectF(mShadowRadius + mRoundCornerRadius, mViewHeight - (mShadowRadius + mRoundCornerRadius), mViewWidth - (mRoundCornerRadius),
																	mViewHeight));
													// //画左下角阴影
													RectF rf = new RectF(0, mViewHeight - 2 * (mShadowRadius + mRoundCornerRadius), 2 * (mShadowRadius + mRoundCornerRadius), mViewHeight);
													drawArcRadialGradient(canvas, mShadowRadius + mRoundCornerRadius, mViewHeight - (mShadowRadius + mRoundCornerRadius),
													...
													// //画右下角阴影
													rf = new RectF(mViewWidth - 2 * (mRoundCornerRadius), mViewHeight - 2 * (mShadowRadius + mRoundCornerRadius), mViewWidth, mViewHeight);
													drawArcRadialGradient(canvas, mViewWidth - (mRoundCornerRadius), mViewHeight - (mShadowRadius + mRoundCornerRadius),
															mShadowRadius + mRoundCornerRadius, colors, floats, Shader.TileMode.CLAMP, rf, 0, 90);

												} else {
													// 画左边阴影
													drawRectLinearGradient(canvas, mShadowRadius, 0, 0, 0, colors, floats, Shader.TileMode.CLAMP,
															new RectF(0, 0, mShadowRadius, mViewHeight - mShadowRadius));
						...
						if ((mCornerPosition & CORNER_LEFT_TOP) == CORNER_LEFT_TOP && (mCornerPosition & CORNER_RIGHT_TOP) != CORNER_RIGHT_TOP
							...
							if ((mCornerPosition & CORNER_LEFT_TOP) != CORNER_LEFT_TOP && (mCornerPosition & CORNER_RIGHT_TOP) == CORNER_RIGHT_TOP
									&& (mCornerPosition & CORNER_RIGHT_BOTTOM) == CORNER_RIGHT_BOTTOM) {
										...
										drawRightSide(canvas, colors, floats, mViewWidth - (mShadowRadius + mRoundCornerRadius), mShadowRadius + mRoundCornerRadius, mViewWidth,
												mViewHeight - mRoundCornerRadius);
									...
									if ((mCornerPosition & CORNER_LEFT_TOP) != CORNER_LEFT_TOP && (mCornerPosition & CORNER_RIGHT_TOP) == CORNER_RIGHT_TOP
										...
										if ((mCornerPosition & CORNER_LEFT_TOP) != CORNER_LEFT_TOP && (mCornerPosition & CORNER_RIGHT_TOP) != CORNER_RIGHT_TOP
												&& (mCornerPosition & CORNER_RIGHT_BOTTOM) == CORNER_RIGHT_BOTTOM) {
													...
													drawRightSide(canvas, colors, floats, mViewWidth - (mShadowRadius + mRoundCornerRadius), mShadowRadius, mViewWidth,
															mViewHeight - mRoundCornerRadius);
					...
					if ((mCornerPosition & CORNER_LEFT_TOP) == CORNER_LEFT_TOP && (mCornerPosition & CORNER_RIGHT_TOP) == CORNER_RIGHT_TOP
							&& (mCornerPosition & CORNER_RIGHT_BOTTOM) == CORNER_RIGHT_BOTTOM && (mCornerPosition & CORNER_LEFT_BOTTOM) == CORNER_LEFT_BOTTOM) {
								...
								if ((mCornerPosition & CORNER_LEFT_TOP) == CORNER_LEFT_TOP && (mCornerPosition & CORNER_RIGHT_TOP) == CORNER_RIGHT_TOP
									...
									if ((mCornerPosition & CORNER_LEFT_TOP) != CORNER_LEFT_TOP && (mCornerPosition & CORNER_RIGHT_TOP) != CORNER_RIGHT_TOP
											&& (mCornerPosition & CORNER_RIGHT_BOTTOM) == CORNER_RIGHT_BOTTOM && (mCornerPosition & CORNER_LEFT_BOTTOM) == CORNER_LEFT_BOTTOM) {
												...
												drawBottomSide(canvas, colors, floats, mRoundCornerRadius, mViewHeight - mRoundCornerRadius - mShadowRadius, mViewWidth - mRoundCornerRadius,
														mViewHeight);
												...
												if ((mCornerPosition & CORNER_LEFT_TOP) == CORNER_LEFT_TOP && (mCornerPosition & CORNER_RIGHT_TOP) != CORNER_RIGHT_TOP
													...
													if ((mCornerPosition & CORNER_LEFT_TOP) == CORNER_LEFT_TOP && (mCornerPosition & CORNER_RIGHT_TOP) != CORNER_RIGHT_TOP
															&& (mCornerPosition & CORNER_RIGHT_BOTTOM) == CORNER_RIGHT_BOTTOM && (mCornerPosition & CORNER_LEFT_BOTTOM) != CORNER_LEFT_BOTTOM) {
																...
																drawBottomSide(canvas, colors, floats, 0, mViewHeight - mRoundCornerRadius - mShadowRadius, mViewWidth - mRoundCornerRadius,
																		mViewHeight);
														...
														if ((mCornerPosition & CORNER_LEFT_TOP) == CORNER_LEFT_TOP && (mCornerPosition & CORNER_RIGHT_TOP) == CORNER_RIGHT_TOP
															...
															if ((mCornerPosition & CORNER_LEFT_TOP) != CORNER_LEFT_TOP && (mCornerPosition & CORNER_RIGHT_TOP) != CORNER_RIGHT_TOP
																	&& (mCornerPosition & CORNER_RIGHT_BOTTOM) != CORNER_RIGHT_BOTTOM && (mCornerPosition & CORNER_LEFT_BOTTOM) == CORNER_LEFT_BOTTOM) {
																		...
																		drawBottomSide(canvas, colors, floats, mRoundCornerRadius, mViewHeight - mRoundCornerRadius - mShadowRadius, mViewWidth,
																				mViewHeight);

																	} else
																if ((mCornerPosition & CORNER_LEFT_TOP) != CORNER_LEFT_TOP && (mCornerPosition & CORNER_RIGHT_TOP) != CORNER_RIGHT_TOP
																		&& (mCornerPosition & CORNER_RIGHT_BOTTOM) == CORNER_RIGHT_BOTTOM
																		&& (mCornerPosition & CORNER_LEFT_BOTTOM) != CORNER_LEFT_BOTTOM) {
																	...
																	if ((mCornerPosition & CORNER_LEFT_TOP) == CORNER_LEFT_TOP && (mCornerPosition & CORNER_RIGHT_TOP) != CORNER_RIGHT_TOP
																		...
																		if ((mCornerPosition & CORNER_LEFT_TOP) != CORNER_LEFT_TOP && (mCornerPosition & CORNER_RIGHT_TOP) == CORNER_RIGHT_TOP
																				...
																				&& (mCornerPosition & CORNER_LEFT_BOTTOM) != CORNER_LEFT_BOTTOM) {
																					...
																					drawBottomSide(canvas, colors, floats, 0, mViewHeight - mRoundCornerRadius - mShadowRadius, mViewWidth,
																							mViewHeight);
							...
							if ((mCornerPosition & CORNER_RIGHT_TOP) != CORNER_RIGHT_TOP && (mCornerPosition & CORNER_RIGHT_BOTTOM) != CORNER_RIGHT_BOTTOM
								...
								if ((mCornerPosition & CORNER_RIGHT_TOP) == CORNER_RIGHT_TOP && (mCornerPosition & CORNER_RIGHT_BOTTOM) == CORNER_RIGHT_BOTTOM
										&& (mCornerPosition & CORNER_LEFT_BOTTOM) != CORNER_LEFT_BOTTOM) {
											...
											drawRightSide(canvas, colors, floats, mViewWidth - mShadowRadius - mRoundCornerRadius, mRoundCornerRadius, mViewWidth,
													mViewHeight - mRoundCornerRadius - mShadowRadius);
									...
									if ((mCornerPosition & CORNER_RIGHT_TOP) == CORNER_RIGHT_TOP && (mCornerPosition & CORNER_RIGHT_BOTTOM) != CORNER_RIGHT_BOTTOM
										...
										if ((mCornerPosition & CORNER_RIGHT_TOP) != CORNER_RIGHT_TOP && (mCornerPosition & CORNER_RIGHT_BOTTOM) == CORNER_RIGHT_BOTTOM
												&& (mCornerPosition & CORNER_LEFT_BOTTOM) == CORNER_LEFT_BOTTOM) {
													...
													drawRightSide(canvas, colors, floats, mViewWidth - mShadowRadius - mRoundCornerRadius, 0, mViewWidth,
															mViewHeight - mRoundCornerRadius - mShadowRadius);

													drawRightBottomArcGradient(canvas, colors, floats);

													drawBottomSide(canvas, colors, floats, mRoundCornerRadius, mViewHeight - mShadowRadius - mRoundCornerRadius,
															mViewWidth - mShadowRadius - mRoundCornerRadius, mViewHeight);
					...
					if ((mCornerPosition & CORNER_LEFT_TOP) == CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) == CORNER_LEFT_BOTTOM
							&& (mCornerPosition & CORNER_RIGHT_BOTTOM) == CORNER_RIGHT_BOTTOM && (mCornerPosition & CORNER_RIGHT_TOP) == CORNER_RIGHT_TOP) {
													...
													if ((mCornerPosition & CORNER_LEFT_TOP) != CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) == CORNER_LEFT_BOTTOM
														...
														if ((mCornerPosition & CORNER_LEFT_TOP) != CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) != CORNER_LEFT_BOTTOM
																&& (mCornerPosition & CORNER_RIGHT_BOTTOM) == CORNER_RIGHT_BOTTOM && (mCornerPosition & CORNER_RIGHT_TOP) == CORNER_RIGHT_TOP) {
																	...
																	drawRightSide(canvas, colors, floats, mViewWidth - mShadowRadius - mRoundCornerRadius, mShadowRadius + mRoundCornerRadius,
																			mViewWidth, mViewHeight - mRoundCornerRadius);
															...
															if ((mCornerPosition & CORNER_LEFT_TOP) == CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) == CORNER_LEFT_BOTTOM
																	&& (mCornerPosition & CORNER_RIGHT_BOTTOM) == CORNER_RIGHT_BOTTOM && (mCornerPosition & CORNER_RIGHT_TOP) != CORNER_RIGHT_TOP) {
																		...
																		drawLeftSide(canvas, colors, floats, 0, mShadowRadius + mRoundCornerRadius, mShadowRadius + mRoundCornerRadius,
																				mViewHeight - (mRoundCornerRadius));

																		drawLeftTopArcGradient(canvas, colors, floats);

																		drawTopSide(canvas, colors, floats, mShadowRadius + mRoundCornerRadius, 0, mViewWidth - mShadowRadius,
																				mShadowRadius + mRoundCornerRadius);
																...
																if ((mCornerPosition & CORNER_LEFT_TOP) == CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) == CORNER_LEFT_BOTTOM
																	...
																	if ((mCornerPosition & CORNER_LEFT_TOP) == CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) != CORNER_LEFT_BOTTOM
																			...
																			&& (mCornerPosition & CORNER_RIGHT_TOP) == CORNER_RIGHT_TOP) {
																				...
																				drawTopSide(canvas, colors, floats, mShadowRadius + mRoundCornerRadius, 0,
																						mViewWidth - mShadowRadius - mRoundCornerRadius, mShadowRadius + mRoundCornerRadius);

																				drawRightSide(canvas, colors, floats, mViewWidth - mShadowRadius - mRoundCornerRadius,
																						mShadowRadius + mRoundCornerRadius, mViewWidth, mViewHeight - mRoundCornerRadius);
																		...
																		if ((mCornerPosition & CORNER_LEFT_TOP) != CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) == CORNER_LEFT_BOTTOM
																				...
																				&& (mCornerPosition & CORNER_RIGHT_TOP) == CORNER_RIGHT_TOP) {
																					...
																					drawLeftSide(canvas, colors, floats, 0, mShadowRadius, mShadowRadius + mRoundCornerRadius,
																							mViewHeight - mRoundCornerRadius);
								...
								if ((mCornerPosition & CORNER_LEFT_TOP) != CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) != CORNER_LEFT_BOTTOM
									...
									if ((mCornerPosition & CORNER_LEFT_TOP) == CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) == CORNER_LEFT_BOTTOM
											&& (mCornerPosition & CORNER_RIGHT_BOTTOM) != CORNER_RIGHT_BOTTOM && (mCornerPosition & CORNER_RIGHT_TOP) != CORNER_RIGHT_TOP) {
												...
												drawLeftSide(canvas, colors, floats, 0, mShadowRadius + mRoundCornerRadius, mShadowRadius + mRoundCornerRadius,
														mViewHeight - (mShadowRadius + mRoundCornerRadius));
										...
										if ((mCornerPosition & CORNER_LEFT_TOP) == CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) != CORNER_LEFT_BOTTOM
												&& (mCornerPosition & CORNER_RIGHT_BOTTOM) == CORNER_RIGHT_BOTTOM && (mCornerPosition & CORNER_RIGHT_TOP) != CORNER_RIGHT_TOP) {
													...
													drawBottomSide(canvas, colors, floats, mShadowRadius, mViewHeight - mShadowRadius - mRoundCornerRadius, mViewWidth - mRoundCornerRadius,
															mViewHeight);
											...
											if ((mCornerPosition & CORNER_LEFT_TOP) == CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) != CORNER_LEFT_BOTTOM
												...
												if ((mCornerPosition & CORNER_LEFT_TOP) != CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) == CORNER_LEFT_BOTTOM
														&& (mCornerPosition & CORNER_RIGHT_BOTTOM) == CORNER_RIGHT_BOTTOM && (mCornerPosition & CORNER_RIGHT_TOP) != CORNER_RIGHT_TOP) {
															...
															drawBottomSide(canvas, colors, floats, mShadowRadius + mRoundCornerRadius, mViewHeight - mShadowRadius - mRoundCornerRadius,
																	mViewWidth - mRoundCornerRadius, mViewHeight);
													...
													if ((mCornerPosition & CORNER_LEFT_TOP) != CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) == CORNER_LEFT_BOTTOM
															&& (mCornerPosition & CORNER_RIGHT_BOTTOM) != CORNER_RIGHT_BOTTOM && (mCornerPosition & CORNER_RIGHT_TOP) == CORNER_RIGHT_TOP) {
																...
																drawBottomSide(canvas, colors, floats, mShadowRadius + mRoundCornerRadius, mViewHeight - mShadowRadius - mRoundCornerRadius, mViewWidth,
																		mViewHeight);
														...
														if ((mCornerPosition & CORNER_LEFT_TOP) != CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) != CORNER_LEFT_BOTTOM
																&& (mCornerPosition & CORNER_RIGHT_BOTTOM) == CORNER_RIGHT_BOTTOM && (mCornerPosition & CORNER_RIGHT_TOP) == CORNER_RIGHT_TOP) {
																	...
																	drawBottomSide(canvas, colors, floats, mShadowRadius, mViewHeight - mShadowRadius - mRoundCornerRadius,
																			mViewWidth - mRoundCornerRadius, mViewHeight);
															...
															if ((mCornerPosition & CORNER_LEFT_TOP) == CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) == CORNER_LEFT_BOTTOM
																...
																if ((mCornerPosition & CORNER_LEFT_TOP) == CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) == CORNER_LEFT_BOTTOM
																		&& (mCornerPosition & CORNER_RIGHT_BOTTOM) != CORNER_RIGHT_BOTTOM && (mCornerPosition & CORNER_RIGHT_TOP) == CORNER_RIGHT_TOP) {
																			...
																			drawTopSide(canvas, colors, floats, mShadowRadius + mRoundCornerRadius, 0, mViewWidth - mRoundCornerRadius,
																					mShadowRadius + mRoundCornerRadius);
																	...
																	if ((mCornerPosition & CORNER_LEFT_TOP) == CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) != CORNER_LEFT_BOTTOM
																		...
																		if ((mCornerPosition & CORNER_LEFT_TOP) != CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) == CORNER_LEFT_BOTTOM
																				...
																				&& (mCornerPosition & CORNER_RIGHT_TOP) == CORNER_RIGHT_TOP) {
																					...
																					drawTopSide(canvas, colors, floats, mShadowRadius, 0, mViewWidth - mRoundCornerRadius,
																							mShadowRadius + mRoundCornerRadius);

																					drawBottomSide(canvas, colors, floats, mShadowRadius + mRoundCornerRadius,
																							mViewHeight - mShadowRadius - mRoundCornerRadius, mViewWidth - mRoundCornerRadius, mViewHeight);
					...
					if ((mCornerPosition & CORNER_LEFT_TOP) == CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) == CORNER_LEFT_BOTTOM
						...
						drawBottomSide(canvas, colors, floats, mRoundCornerRadius + mShadowRadius, mViewHeight - mShadowRadius - mRoundCornerRadius, mViewWidth - mRoundCornerRadius - mShadowRadius,
								mViewHeight);
						...
						if ((mCornerPosition & CORNER_LEFT_TOP) != CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) == CORNER_LEFT_BOTTOM
								&& (mCornerPosition & CORNER_RIGHT_BOTTOM) != CORNER_RIGHT_BOTTOM && (mCornerPosition & CORNER_RIGHT_TOP) != CORNER_RIGHT_TOP) {
									...
									drawBottomSide(canvas, colors, floats, mShadowRadius + mRoundCornerRadius, mViewHeight - mShadowRadius - mRoundCornerRadius, mViewWidth - mShadowRadius,
											mViewHeight);
							...
							if ((mCornerPosition & CORNER_LEFT_TOP) != CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) != CORNER_LEFT_BOTTOM
									&& (mCornerPosition & CORNER_RIGHT_BOTTOM) == CORNER_RIGHT_BOTTOM && (mCornerPosition & CORNER_RIGHT_TOP) != CORNER_RIGHT_TOP) {
										...
										drawBottomSide(canvas, colors, floats, mShadowRadius, mViewHeight - mShadowRadius - mRoundCornerRadius, mViewWidth - mShadowRadius - mRoundCornerRadius,
												mViewHeight);
								...
								if ((mCornerPosition & CORNER_LEFT_TOP) != CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) != CORNER_LEFT_BOTTOM
									...
									if ((mCornerPosition & CORNER_LEFT_TOP) == CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) == CORNER_LEFT_BOTTOM
											&& (mCornerPosition & CORNER_RIGHT_BOTTOM) != CORNER_RIGHT_BOTTOM && (mCornerPosition & CORNER_RIGHT_TOP) != CORNER_RIGHT_TOP) {
												...
												drawBottomSide(canvas, colors, floats, mRoundCornerRadius + mShadowRadius, mViewHeight - mShadowRadius - mRoundCornerRadius, mViewWidth - mShadowRadius,
														mViewHeight);
										...
										if ((mCornerPosition & CORNER_LEFT_TOP) == CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) != CORNER_LEFT_BOTTOM
											...
											if ((mCornerPosition & CORNER_LEFT_TOP) == CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) != CORNER_LEFT_BOTTOM
													&& (mCornerPosition & CORNER_RIGHT_BOTTOM) != CORNER_RIGHT_BOTTOM && (mCornerPosition & CORNER_RIGHT_TOP) == CORNER_RIGHT_TOP) {
														...
														drawBottomSide(canvas, colors, floats, mShadowRadius, mViewHeight - mShadowRadius - mRoundCornerRadius, mViewWidth - mShadowRadius,
																mViewHeight);
												...
												if ((mCornerPosition & CORNER_LEFT_TOP) != CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) == CORNER_LEFT_BOTTOM
													...
													if ((mCornerPosition & CORNER_LEFT_TOP) != CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) == CORNER_LEFT_BOTTOM
															&& (mCornerPosition & CORNER_RIGHT_BOTTOM) != CORNER_RIGHT_BOTTOM && (mCornerPosition & CORNER_RIGHT_TOP) == CORNER_RIGHT_TOP) {
																...
																drawBottomSide(canvas, colors, floats, mShadowRadius + mRoundCornerRadius, mViewHeight - mShadowRadius - mRoundCornerRadius,
																		mViewWidth - mShadowRadius, mViewHeight);
														...
														if ((mCornerPosition & CORNER_LEFT_TOP) != CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) != CORNER_LEFT_BOTTOM
															...
															if ((mCornerPosition & CORNER_LEFT_TOP) == CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) == CORNER_LEFT_BOTTOM
																	&& (mCornerPosition & CORNER_RIGHT_BOTTOM) == CORNER_RIGHT_BOTTOM && (mCornerPosition & CORNER_RIGHT_TOP) != CORNER_RIGHT_TOP) {
																		...
																		drawLeftSide(canvas, colors, floats, 0, mRoundCornerRadius, mShadowRadius + mRoundCornerRadius,
																				mViewHeight - (mShadowRadius + mRoundCornerRadius));
																		...
																		drawBottomSide(canvas, colors, floats, mRoundCornerRadius + mShadowRadius, mViewHeight - mShadowRadius - mRoundCornerRadius,
																				mViewWidth - mRoundCornerRadius - mShadowRadius, mViewHeight);
																	...
																	if ((mCornerPosition & CORNER_LEFT_TOP) == CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) != CORNER_LEFT_BOTTOM
																		...
																		if ((mCornerPosition & CORNER_LEFT_TOP) != CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) == CORNER_LEFT_BOTTOM
																				...
																				&& (mCornerPosition & CORNER_RIGHT_TOP) == CORNER_RIGHT_TOP) {
																					...
																					drawLeftSide(canvas, colors, floats, 0, 0, mShadowRadius + mRoundCornerRadius,
																							mViewHeight - (mShadowRadius + mRoundCornerRadius));

																					drawLeftBottomArcGradient(canvas, colors, floats);

																					drawBottomSide(canvas, colors, floats, mRoundCornerRadius + mShadowRadius,
																							mViewHeight - mShadowRadius - mRoundCornerRadius, mViewWidth - mRoundCornerRadius - mShadowRadius,
																							mViewHeight);

																					drawRightTopDownArcGradient(canvas, colors, floats);

																					drawRightSide(canvas, colors, floats, mViewWidth - mShadowRadius - mRoundCornerRadius, mRoundCornerRadius,
																							mViewWidth, mViewHeight - mRoundCornerRadius - mShadowRadius);
									...
									if ((mCornerPosition & CORNER_LEFT_TOP) == CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) == CORNER_LEFT_BOTTOM
										...
										if ((mCornerPosition & CORNER_LEFT_TOP) == CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) != CORNER_LEFT_BOTTOM
												&& (mCornerPosition & CORNER_RIGHT_BOTTOM) == CORNER_RIGHT_BOTTOM && (mCornerPosition & CORNER_RIGHT_TOP) != CORNER_RIGHT_TOP) {
													...
													drawBottomSide(canvas, colors, floats, 0, mViewHeight - mShadowRadius - mRoundCornerRadius, mViewWidth - mShadowRadius - mRoundCornerRadius,
															mViewHeight);
												...
												if ((mCornerPosition & CORNER_LEFT_TOP) != CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) == CORNER_LEFT_BOTTOM
													...
													if ((mCornerPosition & CORNER_LEFT_TOP) != CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) == CORNER_LEFT_BOTTOM
															&& (mCornerPosition & CORNER_RIGHT_BOTTOM) != CORNER_RIGHT_BOTTOM && (mCornerPosition & CORNER_RIGHT_TOP) == CORNER_RIGHT_TOP) {
																...
																drawBottomSide(canvas, colors, floats, mRoundCornerRadius, mViewHeight - mShadowRadius - mRoundCornerRadius, mViewWidth - mShadowRadius,
																		mViewHeight);
														...
														if ((mCornerPosition & CORNER_LEFT_TOP) != CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) != CORNER_LEFT_BOTTOM
																&& (mCornerPosition & CORNER_RIGHT_BOTTOM) == CORNER_RIGHT_BOTTOM && (mCornerPosition & CORNER_RIGHT_TOP) == CORNER_RIGHT_TOP) {
																	...
																	drawRightSide(canvas, colors, floats, mViewWidth - mShadowRadius - mRoundCornerRadius, mShadowRadius + mRoundCornerRadius,
																			mViewWidth, mViewHeight - mShadowRadius - mRoundCornerRadius);

																	drawBottomSide(canvas, colors, floats, 0, mViewHeight - mShadowRadius - mRoundCornerRadius,
																			mViewWidth - mShadowRadius - mRoundCornerRadius, mViewHeight);
															...
															if ((mCornerPosition & CORNER_LEFT_TOP) == CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) == CORNER_LEFT_BOTTOM
																...
																if ((mCornerPosition & CORNER_LEFT_TOP) == CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) == CORNER_LEFT_BOTTOM
																		&& (mCornerPosition & CORNER_RIGHT_BOTTOM) != CORNER_RIGHT_BOTTOM && (mCornerPosition & CORNER_RIGHT_TOP) == CORNER_RIGHT_TOP) {
																			...
																			drawRightSide(canvas, colors, floats, mViewWidth - mShadowRadius - mRoundCornerRadius, mShadowRadius + mRoundCornerRadius,
																					mViewWidth, mViewHeight - mShadowRadius);
																	...
																	if ((mCornerPosition & CORNER_LEFT_TOP) == CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) != CORNER_LEFT_BOTTOM
																			...
																			&& (mCornerPosition & CORNER_RIGHT_TOP) == CORNER_RIGHT_TOP) {
																				...
																				drawRightSide(canvas, colors, floats, mViewWidth - mShadowRadius - mRoundCornerRadius,
																						mShadowRadius + mRoundCornerRadius, mViewWidth, mViewHeight - mRoundCornerRadius - mShadowRadius);
					...
					if ((mCornerPosition & CORNER_LEFT_TOP) == CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) == CORNER_LEFT_BOTTOM
						...
						drawBottomSide(canvas, colors, floats, mShadowRadius + mRoundCornerRadius, mViewHeight - mShadowRadius - mRoundCornerRadius, mViewWidth - mRoundCornerRadius - mShadowRadius,
								mViewHeight);
																...
																if ((mCornerPosition & CORNER_LEFT_TOP) == CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) == CORNER_LEFT_BOTTOM
																	...
																	if ((mCornerPosition & CORNER_LEFT_TOP) == CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) != CORNER_LEFT_BOTTOM
																			...
																			&& (mCornerPosition & CORNER_RIGHT_TOP) == CORNER_RIGHT_TOP) {
																				...
																				drawRightSide(canvas, colors, floats, mViewWidth - mShadowRadius - mRoundCornerRadius,
																						mShadowRadius + mRoundCornerRadius, mViewWidth, mViewHeight - mShadowRadius - mRoundCornerRadius);
																		...
																		if ((mCornerPosition & CORNER_LEFT_TOP) != CORNER_LEFT_TOP && (mCornerPosition & CORNER_LEFT_BOTTOM) == CORNER_LEFT_BOTTOM
																				...
																				&& (mCornerPosition & CORNER_RIGHT_TOP) == CORNER_RIGHT_TOP) {
																					...
																					drawBottomSide(canvas, colors, floats, mShadowRadius + mRoundCornerRadius,
																							mViewHeight - mShadowRadius - mRoundCornerRadius, mViewWidth - mShadowRadius - mRoundCornerRadius,
																							mViewHeight);
	...
	private void drawLeftTopArcGradient(Canvas canvas, int[] colors, float[] floats) {
		...
		drawArcRadialGradient(canvas, mShadowRadius + mRoundCornerRadius, mShadowRadius + mRoundCornerRadius, mShadowRadius + mRoundCornerRadius, colors, floats, Shader.TileMode.CLAMP,
				new RectF(0, 0, 2 * (mShadowRadius + mRoundCornerRadius), 2 * (mShadowRadius + mRoundCornerRadius)), 180, 90);
	...
	private void drawLeftTopUpArcGradient(Canvas canvas, int[] colors, float[] floats) {
		...
		drawArcRadialGradient(canvas, mRoundCornerRadius, mShadowRadius + mRoundCornerRadius, mShadowRadius + mRoundCornerRadius, colors, floats, Shader.TileMode.CLAMP,
				new RectF(0, 0, 2 * (mRoundCornerRadius), 2 * (mShadowRadius + mRoundCornerRadius)), 180, 90);
	...
	private void drawRightTopArcGradient(Canvas canvas, int[] colors, float[] floats) {
		...
		drawArcRadialGradient(canvas, mViewWidth - (mShadowRadius + mRoundCornerRadius), mShadowRadius + mRoundCornerRadius, mShadowRadius + mRoundCornerRadius, colors, floats, Shader.TileMode.CLAMP,
				rf, 270, 90);
	...
	private void drawLeftBottomArcGradient(Canvas canvas, int[] colors, float[] floats) {
		...
		drawArcRadialGradient(canvas, mShadowRadius + mRoundCornerRadius, mViewHeight - (mShadowRadius + mRoundCornerRadius), mShadowRadius + mRoundCornerRadius, colors, floats, Shader.TileMode.CLAMP,
				rf, 90, 90);
	...
	private void drawRightBottomArcGradient(Canvas canvas, int[] colors, float[] floats) {
		...
		drawArcRadialGradient(canvas, mViewWidth - (mShadowRadius + mRoundCornerRadius), mViewHeight - (mShadowRadius + mRoundCornerRadius), mShadowRadius + mRoundCornerRadius, colors, floats,
				Shader.TileMode.CLAMP, rf, 0, 90);
	...
	private void drawRightBottomUpArcGradient(Canvas canvas, int[] colors, float[] floats) {
		...
		drawArcRadialGradient(canvas, mViewWidth - (mShadowRadius + mRoundCornerRadius), mViewHeight - mRoundCornerRadius, mShadowRadius + mRoundCornerRadius, colors, floats, Shader.TileMode.CLAMP,
				rf, 0, 90);
	...
	private void drawRightBottomDownArcGradient(Canvas canvas, int[] colors, float[] floats) {
		...
		drawArcRadialGradient(canvas, mViewWidth - mRoundCornerRadius, mViewHeight - (mShadowRadius + mRoundCornerRadius), mShadowRadius + mRoundCornerRadius, colors, floats, Shader.TileMode.CLAMP,
				rf, 0, 90);
	...
	private void drawArcRadialGradient(Canvas canvas, float centerX, float centerY, float radius, int[] colors, float[] positions, Shader.TileMode tile, RectF rectF, float startAngle,
			float sweepAngle) {
